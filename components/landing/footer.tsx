      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs font-sans text-sm text-muted-foreground leading-relaxed">
              India&apos;s leading AI-powered platform for CA exam preparation. 
              Join thousands of successful students on their journey to becoming 
              Chartered Accountants.
            </p>
          </div>

          <div>
            <h4 className="font-sans text-sm font-semibold text-foreground">Product</h4>
            <ul className="mt-4 space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="font-sans text-sm text-muted-foreground transition-colors hover:text-foreground">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-sans text-sm font-semibold text-foreground">Resources</h4>
            <ul className="mt-4 space-y-3">
          ...
          <div>
            <h4 className="font-sans text-sm font-semibold text-foreground">Legal</h4>
            <ul className="mt-4 space-y-3">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="font-sans text-sm text-muted-foreground">
            © {new Date().getFullYear()} CA PrepPro. All rights reserved.
          </p>
